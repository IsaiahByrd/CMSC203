...
public class CryptoManager {
	...
	public static String caesarEncryption(String plainText, int key) {
		...
		for (char c : plainText.toCharArray()) {
			int shiftedChar = (c - LOWER_RANGE + key) % RANGE + LOWER_RANGE;
	...
	public static String bellasoEncryption(String plainText, String bellasoStr) {
		...
		for (int i = 0; i < plainText.length(); i++) {
			...
			int shiftedChar = (plainChar + bellasoChar - LOWER_RANGE) % RANGE + LOWER_RANGE;
			encryptedText.append((char) shiftedChar);
		}
		return encryptedText.toString();
	}
	...
	public static String caesarDecryption(String encryptedText, int key) {
		...
		for (char c : encryptedText.toCharArray()) {
			int shiftedChar = (c - key % RANGE - UPPER_RANGE) % RANGE + UPPER_RANGE;
	...
	public static String bellasoDecryption(String encryptedText, String bellasoStr) {
		...
		for (int i = 0; i < encryptedText.length(); i++) {
			...
			char bellasoChar = bellasoStr.charAt(i % bellasoLength);
			int shiftedChar = ((encryptedChar - bellasoChar - UPPER_RANGE) % RANGE + UPPER_RANGE);
			decryptedText.append((char) shiftedChar);
		}
		return decryptedText.toString();
	}
